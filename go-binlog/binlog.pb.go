...
type Binlog struct {
	...
	// import_data is marshalled from PrewriteData type, is used only in Import binlog type.
	ImportData       []byte `protobuf:"bytes,8,opt,name=import_data,json=importData" json:"import_data,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
func (m *Binlog) GetImportData() []byte {
	if m != nil {
		return m.ImportData
	}
	return nil
...
func (m *Binlog) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ImportData != nil {
		dAtA[i] = 0x42
		i++
		i = encodeVarintBinlog(dAtA, i, uint64(len(m.ImportData)))
		i += copy(dAtA[i:], m.ImportData)
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *Binlog) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ImportData", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ImportData = append(m.ImportData[:0], dAtA[iNdEx:postIndex]...)
			if m.ImportData == nil {
				m.ImportData = []byte{}
			}
			iNdEx = postIndex
...
var fileDescriptorBinlog = []byte{
	...
	,
}
